...
const primary = [
  ...
  { label: "Provas", href: "/exams" }, { label: "Simulados", href: "/simulations" },
  { label: "Área de Estudos", href: "/study" },
];
const groups = [
  { title: "Concursos & notícias", items: [
    { label: "Concursos", href: "/concursos", icon: Landmark },
